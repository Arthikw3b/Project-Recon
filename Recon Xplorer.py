...
def logo():
    ...
    logo_ascii = """
                                ___ ___ __  __     
                                |_/ |__(   (  )|\ | """+bcolors.BADFAIL+" ●"+bcolors.WARNING+"""_/( | |_/ _ _
                                | \ |__\__ \__)| \|  | |  ||| \                                               | | \
...
# Tool Set
tools_precheck = [
                    ["wapiti"], ["whatweb"], ["nmap"], ["golismero"], ["host"], ["wget"], ["wafw00f"], ["dirb"], ["davtest"], ["theHarvester"], ["xsser"], ["dnsrecon"],["fierce"], ["dnswalk"], ["whois"], ["sslyze"], ["lbd"], ["golismero"], ["dnsenum"],["dmitry"], ["davtest"], ["nikto"], ["dnsmap"], ["amass"]
                 ]
